        ...
        <div className="container mx-auto px-6 py-3">
          <div className="flex items-center justify-between">
            <div className="hidden w-full text-gray-600 md:flex md:items-center">
              ...
              <span className="mx-1 text-sm">NZ</span>
            </div>
            <div className="w-full text-gray-700 md:text-center text-2xl font-semibold">
              Brand
                </div>
            <div className="flex items-center justify-end w-full">
              <button onClick={() => setMenuOpen(true)} className="text-gray-600 focus:outline-none mx-4 sm:mx-0">
      ...
      {menuOpen ? (
        <div className="fixed right-0 top-0 max-w-xs w-full h-full px-6 py-4 transition duration-300 transform overflow-y-auto bg-white border-l-2 border-gray-300">
          <div className="flex items-center justify-between">
            ...
            <button onClick={() => setMenuOpen(false)} className="text-gray-600 focus:outline-none">
          ...
          <div className="mt-8">
            <form className="flex items-center justify-center">
              <input className="form-input w-48 outline-none border border-gray-100 rounded-md px-2 py-2 text-lg" type="text" placeholder="Add promocode" />
